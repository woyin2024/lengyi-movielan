...
**你的家庭私人影院：手机扫码、电视DLNA，直接播放电脑里的影片。**
...
**单文件零安装** · **扫码即看** · **电视直连** · **一个JSON配置**

</div>

---

双击运行一个exe，电脑就能变成家庭媒体服务器—，手机浏览器打开即看，电视在自带「媒体中心」直接发现，无需安装任何App，无需担心任何数据泄露。

## ✨ 功能特性

- **单文件安装**：一个 exe 搞定，前端页面内嵌在应用里，配置只有一个JSON
- **手机即扫即看**：电脑端显示二维码，手机浏览器打开就是影库，支持自由拖进度条
- **电视直连**：智能电视 / 盒子在「媒体中心 · DLNA」里自动发现，原码率播放 MKV、H.265，由电视本地硬解
- **智能转码**：MP4 直连零开销；浏览器播不动的格式自动调用 ffmpeg 转封装 / 转码，边看边转
- **鼠标选目录**：电脑控制台里点选磁盘文件夹即可共享，改动实时生效，单向权限
...
<div align="left">
<img src="public/wechat-qr.png" alt="沃垠AI 公众号二维码" width="680">
</div>
